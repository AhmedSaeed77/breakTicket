                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.Policies')</h3>
                            <div class="card-tools">
                                <a href="{{ url('policy/create') }}" class="btn  btn-dark">@lang('dashboard.Create')</a>                                
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="operations-btns" style="">
                                                <a href="{{ route('policy.edit', $policy['id']) }}" class="btn  btn-dark">@lang('dashboard.Edit')</a>
