    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ url('commonquestion') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <textarea class="form-control" name="question_ar" id="form-control" required></textarea>
                                    </div>

                                    <div class="form-group col-6">
                                        <label for="exampleInputName1"> @lang('dashboard.Question_En')</label>
                                        <textarea class="form-control" name="question_en" id="form-control" required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form-control summernote" name="answer_ar" id="form-control summernote" required></textarea>
                                    </div>

                                    <div class="form-group col-12">
                                        <label for="exampleInputName1"> @lang('dashboard.Answer_En')</label>
                                        <textarea class="form-control summernote" name="answer_en" id="form-control summernote" required></textarea>
                                    </div>
                                </div>
