                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ url('commonquestion/create') }}" class="btn  btn-dark">@lang('dashboard.Create')</a>                                
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="operations-btns" style="">
                                                <a href="{{ route('commonquestion.edit', $question['id']) }}" class="btn  btn-dark">@lang('dashboard.Edit')</a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content float-left">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('commonquestion.destroy' , $question['id'])}}" method="post">
                                                                    @csrf
                                                                    {{method_field('DELETE')}}
