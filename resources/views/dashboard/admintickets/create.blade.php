...
@section('title', __('dashboard.Create') . " " . __('dashboard.Admin_Tickets'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ url('adminticket') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">{{__('dashboard.Create') . " " . __('dashboard.Admin_Tickets')}}</h3>
                            </div>
                            <div class="card-body">
                                @csrf
